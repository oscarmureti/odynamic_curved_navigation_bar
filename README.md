...
This package is a fork of the original curved_navigation_bar from https://github.com/oscarmureti/odynamic_curved_navigation_bar with label for DynamicCurvedNavigationBarItem.
...
```yaml
dependencies:
  dynamic_curved_navigation_bar: ^0.0.2 #latest version
```
